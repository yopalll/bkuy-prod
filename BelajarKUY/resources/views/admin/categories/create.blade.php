        ...
        <form action="{{ route('admin.categories.store') }}"
            ...
            <div class="mb-6">
                ...
                <div class="relative group">
                    ...
                    <label for="imageInput" id="uploadZone" class="flex flex-col items-center justify-center w-full h-48 bg-brand-bg-soft border-2 border-dashed border-slate-300 rounded-3xl cursor-pointer hover:bg-brand-bg-soft/40 hover:border-brand-accent-blue/60 transition-all overflow-hidden relative">
            ...
            <div class="mb-6">
                ...
                <textarea name="description"
                          ...
                          class="w-full bg-brand-bg-soft border border-slate-200 rounded-2xl px-5 py-4 text-sm outline-none focus:ring-4 focus:ring-brand-accent-blue/20 focus:border-brand-accent-blue/40 transition-all resize-none"></textarea>
            ...
            <div class="mb-8">
                ...
                <label class="flex items-center gap-3 bg-brand-bg-soft border border-slate-200 rounded-2xl px-5 py-4 cursor-pointer">
                    ...
                    <input type="checkbox"
                           name="status"
                           value="1"
                           class="w-5 h-5 rounded border-slate-300 text-brand-accent-blue focus:ring-brand-accent-blue/20">
