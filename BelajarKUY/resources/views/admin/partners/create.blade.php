...
<div class="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
    <div>
        ...
        <p class="text-sm text-slate-500 mt-2">
            Unggah logo institusi atau perusahaan rekanan baru.
        </p>
    </div>
...
<div class="max-w-4xl">
    <div class="bg-brand-cream-card rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden">
        ...
        <div class="px-8 py-6 border-b border-slate-100">
            ...
            <p class="text-sm text-slate-400 mt-1">Isi detail partner dan unggah logonya.</p>
        </div>
        ...
        <form action="{{ route('admin.partners.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
            ...
            <div class="mb-8">
                <label class="block text-sm font-semibold text-brand-text-dark mb-3">
                    Logo Partner <span class="text-xs text-rose-500 font-normal">*Wajib (Disarankan rasio kotak/lebar dan transparan SVG/PNG)</span>
                </label>
                ...
                <div class="w-full border-2 border-dashed border-slate-300 rounded-3xl bg-brand-bg-soft p-10 flex flex-col items-center justify-center relative hover:bg-brand-bg-soft/80 transition cursor-pointer group" onclick="document.getElementById('logo').click()">
                    ...
                    <img id="image-preview" src="#" alt="Preview" class="hidden absolute inset-0 w-full h-full object-contain p-4 rounded-3xl z-10" />
                    ...
                    <div id="upload-placeholder" class="flex flex-col items-center z-20 group-hover:scale-105 transition-transform">
                        ...
                        <h3 class="text-sm font-semibold text-brand-text-dark">Klik untuk mengunggah logo</h3>
